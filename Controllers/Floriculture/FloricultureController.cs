...
namespace BotGarden.Web.Controllers.Floriculture
{
	public class FloricultureController : Controller
	{
		...
		public FloricultureController(PlantFamilyService plantFamilyService, BotGardenService botGardenService, GenusService genusService, BotanicGardenContext context)
		{
		...
		[HttpPost("api/Floriculture/Plants/Add")]
